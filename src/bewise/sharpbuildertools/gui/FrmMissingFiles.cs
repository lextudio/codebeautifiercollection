...
namespace BeWise.SharpBuilderTools.Gui {
	...
	class FrmMissingFiles : Form {
        // *************************************************************************
        //                              Constructor
        // *************************************************************************
        internal FrmMissingFiles(IList<string> aFileList) {
            InitializeComponent();
            fFileList = aFileList;
...
#region Windows Form Designer generated code
        ...
        private void InitializeComponent()
		{
			...
			this.btOk.Location = new System.Drawing.Point(360, 280);
			this.btOk.Name = "btOk";
			...
			this.btCancel.Location = new System.Drawing.Point(440, 280);
			...
			this.groupBox2.Size = new System.Drawing.Size(528, 8);
			...
			this.lblSubTitle.Text = "               Return the list of the file missing on disk.";
			// 
			// lblTitle
			// 
			...
			this.lblTitle.Text = "    Missing Files";
			...
			this.ListView.Size = new System.Drawing.Size(504, 184);

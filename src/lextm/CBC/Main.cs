...
namespace Lextm.CBC {
    public class Main {
        ...
        protected static void CreateCBCMenu() {
        ...
        protected static void DoSetShortCut(object sender, EventArgs e) {
            if (!fShortcutEnabled) {
                ...
                _MenuItem = _MenuService.GetMenuItem(Consts.CBC_MENU_NAME);
                _MenuItem.Enabled = true;
		...
		protected static void RegisterAboutBox() {
			...
			Bitmap aBmp = ((Bitmap)(Resources.MyRes.GetObject("CBC36.bmp")));
//            aBmp.MakeTransparent(Color.White);
            _AboutBoxService.AddPluginInfo(
				"Code Beautifier Collection Expert 2.0 for Delphi 2005",//Title
				" CBC Expert 2.0 (2005/June/18) - \r\n"+
        ...
        protected static void RegisterSplashScreen() {
			...
			Bitmap sBmp = ((Bitmap)(Resources.MyRes.GetObject("CBC24.bmp")));
//			sBmp.MakeTransparent(Color.White);

            splashServ.AddPluginBitmap(
				"Code Beautifier Collection 2.0",
                (sBmp).GetHbitmap(),
                false,//isUnregistered
                "",//licenseStatus
                ""); //skuName
        ...
        public static void IDERegister() {
            try {
                ...
                new OTACBCOptions().IDERegister(out _MenuNames, out _MenuShortCuts);
                RegisterMenus(_MenuNames, _MenuShortCuts);
